...
class AdminRoadsideTab extends StatelessWidget {
  const AdminRoadsideTab({super.key});

  static final DocumentReference<Map<String, dynamic>> _doc =
      FirebaseFirestore.instance.collection('app_settings').doc('roadside_services');
  ...
  Future<void> _deleteItem(
    ...
    final ok = await showCupertinoDialog<bool>(
      ...
      builder: (_) => CupertinoAlertDialog(
        title: const Text('Çekici Kaydını Sil'),
        content:
            const Text('Bu çekici/yol yardım kaydını listeden kaldırmak istiyor musunuz?'),
        actions: [
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        index == null
                            ? 'Yeni Çekici / Yol Yardım Ekle'
                            : 'Çekici Kaydını Düzenle',
                      ...
                      _field(nameController, 'Firma / Kurtarıcı Adı'),
                      _field(
                        phoneController,
                        'Telefon Numarası',
                      ...
                      _field(
                        noteController,
                        'Açıklama / Hizmet Bölgesi (isteğe bağlı)',
                        required: false,
                      ),
                      _field(
                        orderController,
                          ...
                          onPressed: () async {
                            ...
                            if (name.isEmpty || phone.isEmpty) {
                              ScaffoldMessenger.of(ctx).showSnackBar(
                                const SnackBar(
                                  content: Text('Firma adı ve telefon zorunlu.'),
                                ),
                              );
                              return;
                            }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 14),
                    const Text(
                      'Henüz çekici / yol yardım kaydı yok.',
                      style: TextStyle(
                    ...
                    const Text(
                      'Sağ alttaki Çekici Ekle butonuyla gerçek çekici ve yol yardım kayıtlarını ekleyebilirsiniz.',
